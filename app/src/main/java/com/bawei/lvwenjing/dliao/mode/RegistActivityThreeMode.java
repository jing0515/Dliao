...
public interface RegistActivityThreeMode {
    //进行网络请求支付时后使用
    public void getData(String phone, String nickname, String sex, String age, String area, String introduce, String password, String lat, String lgi, RegisterInforFragmentDataListener listener);
